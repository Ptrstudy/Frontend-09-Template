      ...
      let answer = await this.prompt([
        ...
        const pkgJson = {
          ...
          "scripts": {
            ...
            "coverage": "nyc  --require @babel/register macha"
          },
          "author": "",
          "license": "ISC",
          "devDependencies": {
          ...
          this.npmInstall(["webpack","webpack-cli", "babel-loader", "vue-loader", "vue-style-loader", 
           "@babel/core","@babel/preset-env", "@babel/register", "@istanbuljs/nyc-config-babel", 
           "babel-plugin-istanbul", "css-loader", "@babel/preset-env",
